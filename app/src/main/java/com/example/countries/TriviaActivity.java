...
public class TriviaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instructions.setText("Enter a number to view a fun fact about that number");
        ...
        btnFindFact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "https://numbersapi.p.rapidapi.com/" + number + "/trivia?fragment=true&json=true";
