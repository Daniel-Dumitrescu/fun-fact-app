...
public class YearActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instructions.setText("Enter a year to view a fun fact that occurred during the year");
        ...
        btnFindFact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "https://numbersapi.p.rapidapi.com/" + year + "/year?fragment=true&json=true";
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        if (response.isSuccessful()) {
                            ...
                            try {
                                ...
                                final String year = obj.getString("number");

                                String finalDate = date;
                                YearActivity.this.runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        textYearMessage.setText(finalDate + year +":");
                                ...
                                YearActivity.this.runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        mTextViewResult.setText("No fun fact available for selected year :(");
                                    }
                                });
                                e.printStackTrace();
                            }
